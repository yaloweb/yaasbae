$(function() {
	...
	leftBannersThumbs.owlCarousel({
		...
		dots: false,
		nav: false,
		onTranslated: leftBannersActive
	});
	...
	$('.left-banners-promo-arrow.next').on('click', function() {
		leftBannersImages.trigger('next.owl.carousel');
	});

	$('.left-banners-promo-arrow.prev').on('click', function() {
		leftBannersImages.trigger('prev.owl.carousel');
	});
