...
!(function (t) {
	if ( document.querySelectorAll('.slider-range').length == 0 ) {
    ...
    function e(o, t) {
        ...
        1 < o.originalEvent.touches.length ||
            ...
            (u = document.createEvent("MouseEvents")).initMouseEvent(t, !0, !0, window, 1, e.screenX, e.screenY, e.clientX, e.clientY, !1, !1, !1, !1, 0, null),
    ...
    (t.support.touch = "ontouchend" in document),
        t.support.touch &&
            ...
            (o._mouseInit = function () {
                var o = this;
                o.element.bind({ touchstart: t.proxy(o, "_touchStart"), touchmove: t.proxy(o, "_touchMove"), touchend: t.proxy(o, "_touchEnd") }), n.call(o);
            }),
            (o._mouseDestroy = function () {
                var o = this;
                o.element.unbind({ touchstart: t.proxy(o, "_touchStart"), touchmove: t.proxy(o, "_touchMove"), touchend: t.proxy(o, "_touchEnd") }), c.call(o);
            }));
    }
})(jQuery);
